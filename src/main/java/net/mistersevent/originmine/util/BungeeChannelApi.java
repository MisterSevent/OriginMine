package net.mistersevent.originmine.util;
...
public class BungeeChannelApi {
   ...
   private Map<String, BungeeChannelApi.ForwardConsumer> forwardListeners;
   private BungeeChannelApi.ForwardConsumer globalForwardListener;

   public static synchronized BungeeChannelApi of(Plugin plugin) {
      return (BungeeChannelApi)registeredInstances.compute(plugin, (k, v) -> {
         if (v == null) {
   ...
   public void registerForwardListener(String channelName, BungeeChannelApi.ForwardConsumer listener) {
         ...
         synchronized(this.callbackMap) {
            ...
            if (!subchannel.equals("PlayerCount") && !subchannel.equals("PlayerList") && !subchannel.equals("UUIDOther") && !subchannel.equals("ServerIP")) {
               ...
               if (callbacks == null) {
                  ...
                  if (this.forwardListeners != null) {
                     synchronized(this.forwardListeners) {
                        BungeeChannelApi.ForwardConsumer listener = (BungeeChannelApi.ForwardConsumer)this.forwardListeners.get(subchannel);
                        if (listener != null) {
